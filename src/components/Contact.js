            ...
            <ContactContainer>
                  <div >
                        ...
                        <a href="tel:+4740075666">
                              <Icon src={Phone} alt="web site design sandvika" ></Icon>&nbsp; &nbsp; Tlf:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  +47 400 75 666
                        </a>
                        <a href="https://wa.me/+4740075666">
                              <Icon src={whatsapp} alt="web site design sandvika" ></Icon>&nbsp; &nbsp;Whatsapp: +47 400 75 666
                        </a>
                        <a href="mailto:info@sitedesign.no">
                              <Icon src={email} alt="web site design sandvika" ></Icon>&nbsp; &nbsp; info@Sitedesign.no
                        </a>
                  </div>
                  <Landingimg src={landing} alt="web site design sandvika"></Landingimg>
