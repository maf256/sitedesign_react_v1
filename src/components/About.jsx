      ...
      return (
            <Maincontainer>
                  <Rowdiv>
                        ...
                        <Imgdiv><img src={`${window.origin}/assets/img/ablout.jpg`} alt="website design sandvika"></img></Imgdiv>
                  </Rowdiv>
                  <Rowdiv>
                        <Imgdiv><img src={`${window.origin}/assets/img/aboutus2.jpg`} alt="website design"></img></Imgdiv>
                        <Textdiv>
                              <H2>OUR STORY</H2>
                  ...
                  <Rowdiv>
                        ...
                        <Imgdiv><img src={`${window.origin}/assets/img/aboutus3.jpg`} alt="webdesign sandvika"></img></Imgdiv>
                  </Rowdiv>
                  <Rowdiv>
                        <Imgdiv><img src={`${window.origin}/assets/img/aboutus4.jpg`} alt="webdesign sandvika"></img></Imgdiv>
                        <Textdiv>
                  ...
                  <Rowdiv>
                        ...
                        <Imgdiv><img src={`${window.origin}/assets/img/aboutus5.jpg`} alt="webdesign sandvika"></img></Imgdiv>
                  </Rowdiv>
