      ...
      return (
            <Maincontainer>
                  <Rowdiv>
                        ...
                        <Imgdiv><img src={`${window.origin}/assets/img/ITConsulting1.jpg`} alt="website design sandvika"></img></Imgdiv>
                  </Rowdiv>
                  <Rowdiv>
                        <Imgdiv><img src={`${window.origin}/assets/img/ITConsulting2.jpg`} alt="website design sandvika"></img></Imgdiv>
                        <Textdiv>
                  ...
                  <Rowdiv>
                        ...
                        <Imgdiv><img src={`${window.origin}/assets/img/ITConsulting3.jpg`} alt="website design sandvika"></img></Imgdiv>
                  </Rowdiv>
                  <Rowdiv>
                        <Imgdiv><img src={`${window.origin}/assets/img/ITConsulting4.jpg`} alt="website design sandvika"></img></Imgdiv>
                        <Textdiv>
                              <H1>UI/UX Design</H1>
