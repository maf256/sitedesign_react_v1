      ...
      return (
            <Maincontainer>
                  <Rowdiv>
                        ...
                        <Imgdiv><img src={`${window.origin}/assets/img/programing1.jpg`} alt="website design sandvika"></img></Imgdiv>
                  </Rowdiv>
                  <Rowdiv>
                        <Imgdiv><img src={`${window.origin}/assets/img/programing2.jpg`} alt="website design sandvika"></img></Imgdiv>
                        <Textdiv>
                  ...
                  <Rowdiv>
                        <Imgdiv><img src={`${window.origin}/assets/img/programing4.jpg`} alt="website design sandvika"></img></Imgdiv>
                        <Textdiv>
                  ...
                  <Rowdiv>
                        ...
                        <Imgdiv><img src={`${window.origin}/assets/img/programing5.jpg`} alt="website design sandvika"></img></Imgdiv>
                  </Rowdiv>
